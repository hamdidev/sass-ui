    ...
    return (
        <section id="faqs">
            <div className="container py-24">
                ...
                <Headline text="Questions? We've got " highlight="answers" />
                <div>
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    ...
                                    <svg
                                        ...
                                        className={twMerge(
                                            "feather feather-plus text-lime-400 flex-shrink-0 transition-all duration-300 ease-in-out cursor-pointer",
